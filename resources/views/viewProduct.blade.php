    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner" style="">
            <div class="carousel-item active">
                <img class="d-block w-100" width="1000px" height="800px" src="{{ asset('images/slider/Ghee-1.jpg') }}"
                    alt="First slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" width="1000px" height="800px"
                    src="{{ asset('images/slider/Himalayan-Pink-Salt-1.jpg') }}" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" width="1000px" height="800px"
                    src="{{ asset('images/slider/seedmix-combo.jpg') }}" alt="Third slide">
            </div>
        </div>
    ...
    <div class="container mt-2 ">
        ...
        <div class="row">
            @foreach ($Products as $item)
                ...
                <div class=" cardDiv col-md-3 mb-3 ">
